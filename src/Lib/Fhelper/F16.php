...
class F16 extends Fhelperabstract 
{
	protected $hname="Кнопка с произвольным текстом подписывает форму (ТЕГ BUTTON)";
	protected $category=6;
	protected $properties_keys=['button_type',"button_delete_flag","button_caption"];
	protected $properties_text=['button_type'=>"Вид кнопки",
	...
	protected $properties_item_type=['button_type'=>2,
